...
else curl -L -o $currdir/update.sh https://raw.githubusercontent.com/IT12666/subs_translate/scripts/update.sh $currdir && chmod +x $currdir/update.sh && exec $currdir/update.sh && echo "Updating" && exec $currdir/update.sh; fi 
