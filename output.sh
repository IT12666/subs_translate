...
else curl -L -o $currdir/update.sh https://github.com/IT12666/subs_translate/releases/download/0.0.0/update.sh $currdir && chmod +x $currdir/update.sh && exec $currdir/update.sh && echo "Updating" && exec $currdir/update.sh; fi 
