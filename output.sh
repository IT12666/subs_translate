...
echo $dirsub/odysee publish --name=$epno --bid=0.01 --file_path=$dirsub --filename=Final.mp4 --fee_address=$(grep -F $epname".chname=" $setup | cut -d "=" -f2) --title=$title --description=$desc
